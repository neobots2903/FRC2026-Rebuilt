...
public class climbIOsparkmax implements climbIO{
    ...
    private SparkMaxConfig configureClimbMotor() {
        ...
        config.closedLoop.pid(
            climbConstants.kClimbP, climbConstants.kClimbI, climbConstants.kClimbD);
        // Configures encoder conversion factors, converting from rotations to degrees
        config.positionConversionFactor(climbConstants.kClimbDegreesPerRotation);
    ...
    public void setClimbRotationDegrees() {
